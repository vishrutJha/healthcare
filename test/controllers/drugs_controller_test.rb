...
class DrugsControllerTest < ActionController::TestCase
  ...
  test "should create drug" do
    assert_difference('Drug.count') do
      post :create, drug: { contra_indication: @drug.contra_indication, dosage: @drug.dosage, indications: @drug.indications, name: @drug.name, sideffect: @drug.sideffect, tname: @drug.tname }
    end
  ...
  test "should update drug" do
    patch :update, id: @drug, drug: { contra_indication: @drug.contra_indication, dosage: @drug.dosage, indications: @drug.indications, name: @drug.name, sideffect: @drug.sideffect, tname: @drug.tname }
    assert_redirected_to drug_path(assigns(:drug))
  end
